 ...
 * @author cr4b
 */
public class show_vac_xin extends javax.swing.JFrame {
    account acc;
    /**
     * Creates new form show_vac_xin
     */
    public show_vac_xin() {
        initComponents();
    }
    public show_vac_xin(account acc) {
        initComponents();
        this.acc = acc;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("          Cùng chung tay  quyên góp quỹ mua vắc xin");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(show_vac_xin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new show_vac_xin().setVisible(true);
            }
        });
    }
